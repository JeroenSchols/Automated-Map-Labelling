...
public class AlgorithmsPane extends JPanel implements ProblemListener, ViewListener {
    ...
    private Algorithm[] algorithmObjects;
    ...
    public void loadAlgorithms() {
        ...
        this.algorithmObjects = Settings.definition.getAlgorithms();
        this.algorithmNames = new String[this.algorithmObjects.length];

        for (int i = 0; i < algorithmObjects.length; i++) {
            Algorithm algo = algorithmObjects[i];
            algorithmNames[i] = algo.getClass().getSimpleName();
    ...
    public Algorithm[] getAlgorithmObjects() {
        return algorithmObjects;
    }

    public void setAlgorithmObjects(Algorithm[] algorithmObjects) {
        this.algorithmObjects = algorithmObjects;
    }
